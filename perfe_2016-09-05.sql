...
# Base de datos: perfe
# Tiempo de Generación: 2016-09-05 9:16:51 p.m. +0000
# ************************************************************
...
# Volcado de tabla wp_em_modal_metas
# ------------------------------------------------------------
...
INSERT INTO `wp_em_modal_metas` (`id`, `modal_id`, `display`, `close`)
VALUES
	(1,1,'a:10:{s:16:\"overlay_disabled\";i:1;s:4:\"size\";s:5:\"large\";s:12:\"custom_width\";d:0;s:17:\"custom_width_unit\";s:1:\"%\";s:13:\"custom_height\";d:0;s:18:\"custom_height_unit\";s:2:\"em\";s:18:\"custom_height_auto\";i:1;s:8:\"location\";s:10:\"center top\";s:8:\"position\";a:5:{s:3:\"top\";d:100;s:4:\"left\";d:0;s:6:\"bottom\";d:0;s:5:\"right\";d:0;s:5:\"fixed\";i:0;}s:9:\"animation\";a:3:{s:4:\"type\";s:4:\"fade\";s:5:\"speed\";s:3:\"350\";s:6:\"origin\";s:10:\"center top\";}}','a:2:{s:13:\"overlay_click\";i:0;s:9:\"esc_press\";i:1;}');

/*!40000 ALTER TABLE `wp_em_modal_metas` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_em_modals
# ------------------------------------------------------------
...
INSERT INTO `wp_em_modals` (`id`, `theme_id`, `name`, `title`, `content`, `created`, `modified`, `is_sitewide`, `is_system`, `is_trash`)
VALUES
	(1,1,'archivo','archivo','<ul>\r\n<li style=\"text-align: center;\">Editorial</li>\r\n<li style=\"text-align: center;\">Branding</li>\r\n<li style=\"text-align: center;\">Video Visuales</li>\r\n<li style=\"text-align: center;\">Fotografía Ilustración</li>\r\n<li style=\"text-align: center;\">Ver todas</li>\r\n</ul>','2016-09-05 18:26:05','2016-09-05 19:22:36',1,0,0);

/*!40000 ALTER TABLE `wp_em_modals` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_em_theme_metas
# ------------------------------------------------------------
...
INSERT INTO `wp_em_themes` (`id`, `name`, `created`, `modified`, `is_system`, `is_trash`)
VALUES
	(1,'Default','2016-09-05 18:24:39','2016-09-05 18:24:39',0,0);

/*!40000 ALTER TABLE `wp_em_themes` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_circles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_circles`;
...
LOCK TABLES `wp_g_circles` WRITE;
/*!40000 ALTER TABLE `wp_g_circles` DISABLE KEYS */;

INSERT INTO `wp_g_circles` (`id`, `map`, `name`, `center_lat`, `center_lng`, `radius`, `line_width`, `line_opacity`, `line_color`, `fill_color`, `fill_opacity`, `hover_line_opacity`, `hover_line_color`, `hover_fill_color`, `hover_fill_opacity`, `show_marker`)
VALUES
	(1,1,'My First Circle','40.805493843894155','-76.3165283203125','50000','5','0.8','FF2B39','4FFF72','0.4','0.6','FF5C5C','96FFA1','0.3',0);

/*!40000 ALTER TABLE `wp_g_circles` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_directions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_directions`;

CREATE TABLE `wp_g_directions` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `map` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
...
LOCK TABLES `wp_g_directions` WRITE;
/*!40000 ALTER TABLE `wp_g_directions` DISABLE KEYS */;

INSERT INTO `wp_g_directions` (`id`, `map`, `name`, `start_lat`, `start_lng`, `end_lat`, `end_lng`, `line_color`, `line_width`, `line_opacity`, `show_steps`, `travel_mode`)
VALUES
	(1,1,'Lyonstown - Locust','40.9419425','-77.7339905','40.2863133','-76.85491560000003','000000','0.5','10','no','DRIVING');

/*!40000 ALTER TABLE `wp_g_directions` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_maps
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_maps`;
...
LOCK TABLES `wp_g_maps` WRITE;
/*!40000 ALTER TABLE `wp_g_maps` DISABLE KEYS */;

INSERT INTO `wp_g_maps` (`id`, `name`, `type`, `zoom`, `border_radius`, `center_lat`, `pan_controller`, `zoom_controller`, `type_controller`, `scale_controller`, `street_view_controller`, `overview_map_controller`, `center_lng`, `width`, `height`, `align`, `wheel_scroll`, `draggable`, `language`, `min_zoom`, `max_zoom`, `info_type`, `traffic_layer`, `bike_layer`, `transit_layer`, `styling_hue`, `styling_lightness`, `styling_gamma`, `styling_saturation`, `animation`)
VALUES
	(1,'My First Map','ROADMAP',7,0,'40.7127837','true','true','true','true','true','true','-74.00594130000002','100','300','center','true','true','location based','0','22','click','false','false','false','','0','1','0','none');

/*!40000 ALTER TABLE `wp_g_maps` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_markers
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_markers`;
...
LOCK TABLES `wp_g_markers` WRITE;
/*!40000 ALTER TABLE `wp_g_markers` DISABLE KEYS */;

INSERT INTO `wp_g_markers` (`id`, `map`, `title`, `lat`, `lng`, `animation`, `description`, `img`, `size`)
VALUES
	(1,1,'New York','40.7127837','-74.00594130000002','BOUNCE','New York City','',''),
	(2,1,'Delaver','39.189690821096804','-75.7562255859375','DROP','Delaver','','');

/*!40000 ALTER TABLE `wp_g_markers` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_polygones
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_polygones`;
...
LOCK TABLES `wp_g_polygones` WRITE;
/*!40000 ALTER TABLE `wp_g_polygones` DISABLE KEYS */;

INSERT INTO `wp_g_polygones` (`id`, `map`, `name`, `data`, `line_opacity`, `line_color`, `fill_opacity`, `fill_color`, `url`, `hover_line_opacity`, `hover_line_color`, `hover_fill_opacity`, `hover_fill_color`, `line_width`)
VALUES
...
/*!40000 ALTER TABLE `wp_g_polygones` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla wp_g_polylines
# ------------------------------------------------------------

DROP TABLE IF EXISTS `wp_g_polylines`;
...
LOCK TABLES `wp_g_polylines` WRITE;
/*!40000 ALTER TABLE `wp_g_polylines` DISABLE KEYS */;

INSERT INTO `wp_g_polylines` (`id`, `map`, `name`, `data`, `line_opacity`, `line_color`, `line_width`, `hover_line_color`, `hover_line_opacity`)
VALUES
...
/*!40000 ALTER TABLE `wp_g_polylines` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(104,'cron','a:11:{i:1473110620;a:3:{s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1473110634;a:1:{s:19:\"wp_scheduled_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}i:1473113082;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"0396e4b982c02f4390cf87bf7998a422\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:92;}}}}i:1473113186;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"cd78f31ad43af907af7f9d382ac86b75\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:93;}}}}i:1473113274;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"701d35ae68fbb3c691763d899f3d839c\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:94;}}}}i:1473114412;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"621568af08fa4ca7d1d1420e6055ffbb\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:96;}}}}i:1473114482;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"0890eb47e933786c705def661562337a\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:97;}}}}i:1473114503;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"d13e25e7d92ea83e0f670149684b0c8d\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:98;}}}}i:1473114543;a:1:{s:26:\"upgrader_scheduled_cleanup\";a:1:{s:32:\"8e37d112eed2311de901b0df41a405d3\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:1:{i:0;i:99;}}}}i:1473193097;a:1:{s:30:\"wp_scheduled_auto_draft_delete\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}','yes'),
	...
	(315,'_transient_timeout_plugin_slugs','1473196170','no'),
	(316,'_transient_plugin_slugs','a:20:{i:0;s:30:\"advanced-custom-fields/acf.php\";i:1;s:19:\"akismet/akismet.php\";i:2;s:45:\"bootstrap-shortcodes/bootstrap-shortcodes.php\";i:3;s:51:\"display-posts-shortcode/display-posts-shortcode.php\";i:4;s:25:\"easy-modal/easy-modal.php\";i:5;s:9:\"hello.php\";i:6;s:25:\"google-maps/googlemap.php\";i:7;s:47:\"regenerate-thumbnails/regenerate-thumbnails.php\";i:8;s:26:\"snazzy-maps/snazzymaps.php\";i:9;s:35:\"premium-support/premium-support.php\";i:10;s:31:\"pro-developer/pro-developer.php\";i:11;s:25:\"pro-bundle/pro-bundle.php\";i:12;s:37:\"unlimited-themes/unlimited-themes.php\";i:13;s:27:\"scroll-pops/scroll-pops.php\";i:14;s:39:\"force-user-action/force-user-action.php\";i:15;s:37:\"age-verification/age-verification.php\";i:16;s:47:\"advanced-theme-editor/advanced-theme-editor.php\";i:17;s:27:\"exit-modals/exit-modals.php\";i:18;s:23:\"auto-open/auto-open.php\";i:19;s:29:\"login-modals/login-modals.php\";}','no'),
...
VALUES
	...
	(265,88,'_edit_last','1'),
	(266,88,'_edit_lock','1473110033:1'),
	(267,88,'_thumbnail_id','38'),
	(268,23,'_wp_trash_meta_status','publish'),
	(269,23,'_wp_trash_meta_time','1472498371'),
	(270,23,'_wp_desired_post_slug','trabajos'),
	(271,91,'_menu_item_type','custom'),
	(272,91,'_menu_item_menu_item_parent','0'),
	(273,91,'_menu_item_object_id','91'),
	(274,91,'_menu_item_object','custom'),
	(275,91,'_menu_item_target',''),
	(276,91,'_menu_item_classes','a:1:{i:0;s:8:\"eModal-1\";}'),
	(277,91,'_menu_item_xfn',''),
	(278,91,'_menu_item_url',''),
	(280,92,'_wp_attached_file','2016/09/cubeportfolio.zip'),
	(281,92,'_wp_attachment_context','upgrader'),
	(282,93,'_wp_attached_file','2016/09/cbp-plugin.zip'),
	(283,93,'_wp_attachment_context','upgrader'),
	(284,94,'_wp_attached_file','2016/09/Cube-Portfolio.zip'),
	(285,94,'_wp_attachment_context','upgrader'),
	(286,96,'_wp_attached_file','2016/09/Cube-Portfolio-1.zip'),
	(287,96,'_wp_attachment_context','upgrader'),
	(288,97,'_wp_attached_file','2016/09/cubeportfolio-1.zip'),
	(289,97,'_wp_attachment_context','upgrader'),
	(290,98,'_wp_attached_file','2016/09/cbp-plugin-1.zip'),
	(291,98,'_wp_attachment_context','upgrader'),
	(292,99,'_wp_attached_file','2016/09/templates.zip'),
	(293,99,'_wp_attachment_context','upgrader');
...
VALUES
	...
	(10,1,'2016-08-09 20:38:42','2016-08-09 20:38:42','','Blog','','publish','closed','closed','','blog','','','2016-08-29 16:47:09','2016-08-29 16:47:09','',0,'http://perfe-wp/?page_id=10',0,'page','',0),
	...
	(19,1,'2016-08-09 20:48:30','2016-08-09 20:48:30',' ','','','publish','closed','closed','','19','','','2016-09-05 19:14:22','2016-09-05 19:14:22','',0,'http://perfe-wp/?p=19',2,'nav_menu_item','',0),
	...
	(23,1,'2016-08-11 21:04:22','2016-08-11 21:04:22','','Trabajos','','trash','closed','closed','','trabajos__trashed','','','2016-08-29 19:19:31','2016-08-29 19:19:31','',0,'http://perfe-wp/?page_id=23',0,'page','',0),
	...
	(32,1,'2016-08-11 21:16:13','2016-08-11 21:16:13',' ','','','publish','closed','closed','','32','','','2016-09-05 19:14:22','2016-09-05 19:14:22','',0,'http://perfe-wp/?p=32',1,'nav_menu_item','',0),
	...
	(66,1,'2016-08-23 19:33:33','2016-08-23 19:33:33',' ','','','publish','closed','closed','','66','','','2016-09-05 19:14:22','2016-09-05 19:14:22','',0,'http://perfe-wp/?p=66',3,'nav_menu_item','',0),
	...
	(91,1,'2016-09-05 18:33:46','2016-09-05 18:33:46','','Archivo','','publish','closed','closed','','archivo','','','2016-09-05 19:14:22','2016-09-05 19:14:22','',0,'http://perfe-wp/?p=91',4,'nav_menu_item','',0),
	(92,1,'2016-09-05 20:04:42','2016-09-05 20:04:42','http://perfe-wp/wp-content/uploads/2016/09/cubeportfolio.zip','cubeportfolio.zip','','private','open','closed','','cubeportfolio-zip','','','2016-09-05 20:04:42','2016-09-05 20:04:42','',0,'http://perfe-wp/wp-content/uploads/2016/09/cubeportfolio.zip',0,'attachment','',0),
	(93,1,'2016-09-05 20:06:26','2016-09-05 20:06:26','http://perfe-wp/wp-content/uploads/2016/09/cbp-plugin.zip','cbp-plugin.zip','','private','open','closed','','cbp-plugin-zip','','','2016-09-05 20:06:26','2016-09-05 20:06:26','',0,'http://perfe-wp/wp-content/uploads/2016/09/cbp-plugin.zip',0,'attachment','',0),
	(94,1,'2016-09-05 20:07:54','2016-09-05 20:07:54','http://perfe-wp/wp-content/uploads/2016/09/Cube-Portfolio.zip','Cube Portfolio.zip','','private','open','closed','','cube-portfolio-zip','','','2016-09-05 20:07:54','2016-09-05 20:07:54','',0,'http://perfe-wp/wp-content/uploads/2016/09/Cube-Portfolio.zip',0,'attachment','',0),
	(95,1,'2016-09-05 20:24:42','0000-00-00 00:00:00','','Borrador automático','','auto-draft','open','open','','','','','2016-09-05 20:24:42','0000-00-00 00:00:00','',0,'http://perfe-wp/?p=95',0,'post','',0),
	(96,1,'2016-09-05 20:26:52','2016-09-05 20:26:52','http://perfe-wp/wp-content/uploads/2016/09/Cube-Portfolio-1.zip','Cube Portfolio.zip','','private','open','closed','','cube-portfolio-zip-2','','','2016-09-05 20:26:52','2016-09-05 20:26:52','',0,'http://perfe-wp/wp-content/uploads/2016/09/Cube-Portfolio-1.zip',0,'attachment','',0),
	(97,1,'2016-09-05 20:28:02','2016-09-05 20:28:02','http://perfe-wp/wp-content/uploads/2016/09/cubeportfolio-1.zip','cubeportfolio.zip','','private','open','closed','','cubeportfolio-zip-2','','','2016-09-05 20:28:02','2016-09-05 20:28:02','',0,'http://perfe-wp/wp-content/uploads/2016/09/cubeportfolio-1.zip',0,'attachment','',0),
	(98,1,'2016-09-05 20:28:23','2016-09-05 20:28:23','http://perfe-wp/wp-content/uploads/2016/09/cbp-plugin-1.zip','cbp-plugin.zip','','private','open','closed','','cbp-plugin-zip-2','','','2016-09-05 20:28:23','2016-09-05 20:28:23','',0,'http://perfe-wp/wp-content/uploads/2016/09/cbp-plugin-1.zip',0,'attachment','',0),
	(99,1,'2016-09-05 20:29:03','2016-09-05 20:29:03','http://perfe-wp/wp-content/uploads/2016/09/templates.zip','templates.zip','','private','open','closed','','templates-zip','','','2016-09-05 20:29:03','2016-09-05 20:29:03','',0,'http://perfe-wp/wp-content/uploads/2016/09/templates.zip',0,'attachment','',0),
	(100,1,'2016-09-05 21:07:19','2016-09-05 21:07:19','<img class=\"aligncenter wp-image-38 size-full\" src=\"http://perfe-wp/wp-content/uploads/2016/08/1_03.png\" alt=\"1_03\" width=\"860\" height=\"479\" />\r\n\r\n&nbsp;\r\n\r\nWe are excited to announce our September, 2016 issue, with a special focus on our upcoming \"Juxtapoz x Superflat\" exhibition co-curated by <a href=\"http://www.juxtapoz.com/tag/Takashi-Murakami\">Takashi Murakami</a> and taking place in Seattle from August 4—7, 2016. We start with a discussion with Takashi about how we the show came about, and the curation process of bringing a new version of his renowned Superflat concept to life. In conjunction with the show, we enlisted <a href=\"http://www.juxtapoz.com/tag/james-jean\">James Jean</a> as the cover artist, both a participant in the show and a longtime friend of both <em>Juxtapoz</em> and Takashi.\r\n\r\nSubscribe to <em>Juxtapoz Magazine</em> and get this issue <a href=\"http://shop.juxtapoz.com/1-year-usa-subscription-free-current-issue.html\">for FREE!</a>\r\n\r\n<strong>Also in September 2016</strong>\r\n\r\n—A special studio visit with <strong>Elisabeth Higgins O\'Connor</strong> as she builds new sculptural works for \"Juxtapoz x Superflat.\"\r\n—We sit down with author and artist <strong>Dave Eggers</strong> and ask him what comes first... the animal or the phrase?\r\n—<strong>Camille Rose Garcia</strong> takes us on a Phantasmacabre adventure\r\n—<strong>Robert Hardgrave</strong> delights in the discovery of new work\r\n—<strong>Mary Iverson</strong> takes us on a city tour to <strong>Seattle\r\n</strong>—<strong>Tom Sachs</strong> prepares us for outer space\r\n—<strong>Michael Marcelle</strong> shoots the Red Strawberry\r\n—<strong>Flavor Paper</strong> reinvents the wallpaper\r\n—<strong>Morph Knitwear</strong> makes sweaters for all seasons\r\n—<strong>Russ Pope</strong> rolls through Boston\r\n—We share a six pack with <strong>Mel Kadel\r\n</strong>— . . . and <strong>Kevin Peterson</strong> makes his Getaway','ISSUE PREVIEW: SEPTEMBER 2016 WITH JAMES JEAN AND SUPERFLAT','','inherit','closed','closed','','88-autosave-v1','','','2016-09-05 21:07:19','2016-09-05 21:07:19','',88,'http://perfe-wp/88-autosave-v1/',0,'revision','',0),
	(101,1,'2016-09-05 21:04:25','2016-09-05 21:04:25','<img class=\"size-medium wp-image-49 alignleft\" src=\"http://perfe-wp/wp-content/uploads/2016/08/Captura-de-pantalla-2016-08-17-a-las-5.08.34-p.m.-258x300.png\" alt=\"Captura de pantalla 2016-08-17 a las 5.08.34 p.m.\" width=\"258\" height=\"300\" />\r\n\r\n<img class=\"size-medium wp-image-49 alignright\" src=\"http://perfe-wp/wp-content/uploads/2016/08/Captura-de-pantalla-2016-08-17-a-las-5.08.34-p.m.-258x300.png\" alt=\"Captura de pantalla 2016-08-17 a las 5.08.34 p.m.\" width=\"258\" height=\"300\" />\r\n\r\nWe are excited to announce our September, 2016 issue, with a special focus on our upcoming \"Juxtapoz x Superflat\" exhibition co-curated by <a href=\"http://www.juxtapoz.com/tag/Takashi-Murakami\">Takashi Murakami</a> and taking place in Seattle from August 4—7, 2016. We start with a discussion with Takashi about how we the show came about, and the curation process of bringing a new version of his renowned Superflat concept to life. In conjunction with the show, we enlisted <a href=\"http://www.juxtapoz.com/tag/james-jean\">James Jean</a> as the cover artist, both a participant in the show and a longtime friend of both <em>Juxtapoz</em> and Takashi.\r\n\r\nSubscribe to <em>Juxtapoz Magazine</em> and get this issue <a href=\"http://shop.juxtapoz.com/1-year-usa-subscription-free-current-issue.html\">for FREE!</a>\r\n\r\n<strong>Also in September 2016</strong>\r\n\r\n—A special studio visit with <strong>Elisabeth Higgins O\'Connor</strong> as she builds new sculptural works for \"Juxtapoz x Superflat.\"\r\n—We sit down with author and artist <strong>Dave Eggers</strong> and ask him what comes first... the animal or the phrase?\r\n—<strong>Camille Rose Garcia</strong> takes us on a Phantasmacabre adventure\r\n—<strong>Robert Hardgrave</strong> delights in the discovery of new work\r\n—<strong>Mary Iverson</strong> takes us on a city tour to <strong>Seattle\r\n</strong>—<strong>Tom Sachs</strong> prepares us for outer space\r\n—<strong>Michael Marcelle</strong> shoots the Red Strawberry\r\n—<strong>Flavor Paper</strong> reinvents the wallpaper\r\n—<strong>Morph Knitwear</strong> makes sweaters for all seasons\r\n—<strong>Russ Pope</strong> rolls through Boston\r\n—We share a six pack with <strong>Mel Kadel\r\n</strong>— . . . and <strong>Kevin Peterson</strong> makes his Getaway','ISSUE PREVIEW: SEPTEMBER 2016 WITH JAMES JEAN AND SUPERFLAT','','inherit','closed','closed','','88-revision-v1','','','2016-09-05 21:04:25','2016-09-05 21:04:25','',88,'http://perfe-wp/88-revision-v1/',0,'revision','',0),
	(102,1,'2016-09-05 21:07:40','2016-09-05 21:07:40','<img class=\"aligncenter wp-image-38 size-full\" src=\"http://perfe-wp/wp-content/uploads/2016/08/1_03.png\" alt=\"1_03\" width=\"860\" height=\"479\" />\r\n\r\n&nbsp;\r\n\r\nWe are excited to announce our September, 2016 issue, with a special focus on our upcoming \"Juxtapoz x Superflat\" exhibition co-curated by <a href=\"http://www.juxtapoz.com/tag/Takashi-Murakami\">Takashi Murakami</a> and taking place in Seattle from August 4—7, 2016. We start with a discussion with Takashi about how we the show came about, and the curation process of bringing a new version of his renowned Superflat concept to life. In conjunction with the show, we enlisted <a href=\"http://www.juxtapoz.com/tag/james-jean\">James Jean</a> as the cover artist, both a participant in the show and a longtime friend of both <em>Juxtapoz</em> and Takashi.\r\n\r\nSubscribe to <em>Juxtapoz Magazine</em> and get this issue <a href=\"http://shop.juxtapoz.com/1-year-usa-subscription-free-current-issue.html\">for FREE!</a>\r\n\r\n<strong>Also in September 2016</strong>\r\n\r\n—A special studio visit with <strong>Elisabeth Higgins O\'Connor</strong> as she builds new sculptural works for \"Juxtapoz x Superflat.\"\r\n—We sit down with author and artist <strong>Dave Eggers</strong> and ask him what comes first... the animal or the phrase?\r\n—<strong>Camille Rose Garcia</strong> takes us on a Phantasmacabre adventure\r\n—<strong>Robert Hardgrave</strong> delights in the discovery of new work\r\n—<strong>Mary Iverson</strong> takes us on a city tour to <strong>Seattle\r\n</strong>—<strong>Tom Sachs</strong> prepares us for outer space\r\n—<strong>Michael Marcelle</strong> shoots the Red Strawberry\r\n—<strong>Flavor Paper</strong> reinvents the wallpaper\r\n—<strong>Morph Knitwear</strong> makes sweaters for all seasons\r\n—<strong>Russ Pope</strong> rolls through Boston\r\n—We share a six pack with <strong>Mel Kadel\r\n</strong>— . . . and <strong>Kevin Peterson</strong> makes his Getaway','ISSUE PREVIEW: SEPTEMBER 2016 WITH JAMES JEAN AND SUPERFLAT','','inherit','closed','closed','','88-revision-v1','','','2016-09-05 21:07:40','2016-09-05 21:07:40','',88,'http://perfe-wp/88-revision-v1/',0,'revision','',0);
...
VALUES
	...
	(14,1,'session_tokens','a:1:{s:64:\"edef9875fb5a9eeb0e3a9014c1ad1b2b43780ae8e8ac88a72ba0fc1f02a3d164\";a:4:{s:10:\"expiration\";i:1473261415;s:2:\"ip\";s:3:\"::1\";s:2:\"ua\";s:121:\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36\";s:5:\"login\";i:1473088615;}}'),
	...
	(21,1,'wp_user-settings','libraryContent=browse&editor=tinymce&editor_expand=on&hidetb=1'),
	(22,1,'wp_user-settings-time','1473109657'),
	...
	(25,1,'meta-box-order_post','a:4:{s:15:\"acf_after_title\";s:0:\"\";s:4:\"side\";s:51:\"submitdiv,categorydiv,tagsdiv-post_tag,postimagediv\";s:6:\"normal\";s:90:\"acf_76,postexcerpt,trackbacksdiv,postcustom,commentstatusdiv,commentsdiv,slugdiv,authordiv\";s:8:\"advanced\";s:10:\"easy-modal\";}'),
	(26,1,'screen_layout_post','2'),
	(27,1,'closedpostboxes_post','a:0:{}'),
	(28,1,'metaboxhidden_post','a:8:{i:0;s:6:\"acf_76\";i:1;s:11:\"postexcerpt\";i:2;s:13:\"trackbacksdiv\";i:3;s:16:\"commentstatusdiv\";i:4;s:11:\"commentsdiv\";i:5;s:7:\"slugdiv\";i:6;s:9:\"authordiv\";i:7;s:12:\"revisionsdiv\";}');
